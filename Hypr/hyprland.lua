...
-- EDIT THIS CONFIG ACCORDING TO THE WIKI INSTRURTCTIONS.  --
...
hl.config({
    general = {
        ...
        col = {
            active_border   = { colors = {"rgba(255, 255, 255, 0.8)", "rgba(255, 255, 255, 0.8)"}, angle = 45 },
            inactive_border = { colors = {"rgba(36, 36, 36, 0.8)", "rgba(36, 36, 36, 0.8)"}, angle = 45 },
        },
...
-- [GNOME CONVERTIDO] Abrir Terminal com CTRL + ALT + T
hl.bind(mainMod .. "+ Q", hl.dsp.exec_cmd(terminal))

-- [GNOME CONVERTIDO] Fechar Janela ativa com ALT + F4
hl.bind("ALT + F4", hl.dsp.window.close())
hl.bind(mainMod .. "+ C", hl.dsp.window.close())

-- [GNOME] Menu de Aplicativos (Apenas apertar a tecla SUPER)
